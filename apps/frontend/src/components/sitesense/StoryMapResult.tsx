...
const MapPanel = dynamic(
  () => import("./MapPanel").then((m) => m.MapPanel),
  {
    ...
    loading: () => (
      <div
        className="w-full h-full min-h-[400px] rounded-2xl flex items-center justify-center text-sm"
...
export function StoryMapResult({
  ...
  // IntersectionObserver-driven chapter activation
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: "rgba(244,249,238,0.94)",
